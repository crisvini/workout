...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07-Set-2022 às 02:09
...
(4, 'Supino reto', 'Faça 500 repetições de supino reto', 48, 1, 48, 'true'),
(5, 'Encolhimento (halter)', 'Faça 500 repetições de encolhimento (halter)', 48, 28, 48, 'true'),
(9, 'Elevação lateral', 'Faça 500 repetições de elevação lateral', 48, 26, 48, 'true');
...
INSERT INTO `ranking` (`id_ranking`, `_id_usuario`, `nome`, `pontuacao`) VALUES
(1, 34, 'Cristian Vinícius Leoncini Lopes', 144),
(2, 38, 'Cristiano Lopes da Silva', 0);
...
--
ALTER TABLE `metas_usuarios`
  MODIFY `id_metas_usuarios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `usuarios`
  MODIFY `id_usuarios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
