...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Ago-2022 às 01:58
...
INSERT INTO `metas` (`id_metas`, `nome`, `descricao`, `pontos`, `_id_exercicio`, `quantidade`, `ativo`) VALUES
(4, 'Supino reto', 'Faça 500 repetições de supino reto', 500, 1, 500, 'true'),
(5, 'Encolhimento (halter)', 'Faça 500 repetições de encolhimento (halter)', 500, 28, 500, 'true'),
(9, 'Elevação lateral', 'Faça 500 repetições de elevação lateral', 500, 26, 500, 'true');
...
CREATE TABLE `usuarios` (
  ...
  `pontuacao_semanal` int(10) NOT NULL,
  `pontuacao_geral` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `metas`
  MODIFY `id_metas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `metas_usuarios`
--
ALTER TABLE `metas_usuarios`
  MODIFY `id_metas_usuarios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
